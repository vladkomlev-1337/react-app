...
function Home() {
    ...
    const checkAuth = async ()=>{
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$react$2d$app$2f$src$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].getCurrentUser();
        setCurrentUser(user);
    };
    const loadUsers = async ()=>{
        setIsLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$react$2d$app$2f$src$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].getUsers();
            setUsers(data);
        } catch (error) {
    ...
    const handleRegister = async (e)=>{
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$react$2d$app$2f$src$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].register(name, email, password);
        if (newUser) {
    ...
    const handleLogin = async (e)=>{
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$react$2d$app$2f$src$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].login(loginEmail, loginPassword);
        if (user) {
    ...
    const handleDeleteUser = async (id)=>{
        if (confirm('Удалить пользователя?')) {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$react$2d$app$2f$src$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].deleteUser(id);
            if (success) {
                loadUsers();
            }
        }
...
//# sourceMappingURL=Desktop_react-app_src_5efbb829._.js.map